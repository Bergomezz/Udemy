describe('Transfer Found Test', () => {
	...
	it('should verify correct data', () => {
		...
		cy.get('#tf_description').should('have.value', 'Anything you wanted')
	})
})
